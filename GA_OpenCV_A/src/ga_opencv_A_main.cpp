...
const int GENE_LENGTH=56; //每條基因的長度
const int POPULATION_NUMBER=2; //有多少條基因
...
#define Rand()((double)rand()/(double)RAND_MAX) //可以隨機產生0~1的亂數
